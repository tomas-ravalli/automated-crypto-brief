...
# [REFACTORED] This entire function is updated for the new email layout.
...
🌐 © 2025 t.r."""
    ...
    # Set plain text content in the new order
    ...
    if chart_path:
        ...
        html_body = f"""
        <html><body>
            <pre style="font-family: sans-serif; margin: 0;">{body_metrics_perf}</pre>
            <hr>
